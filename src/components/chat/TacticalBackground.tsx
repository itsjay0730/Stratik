...
export function TacticalBackground({ game = 'valorant' }: TacticalBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const primaryColor = isLeague 
      ? { r: 200, g: 170, b: 110 } // Gold for LoL
      : { r: 255, g: 70, b: 85 };   // Red for Valorant
    ...
    const draw = () => {
      ...
      nodes.forEach((node) => {
        ...
        glow.addColorStop(0, `rgba(${primaryColor.r}, ${primaryColor.g}, ${primaryColor.b}, ${alpha * 0.6})`);
        glow.addColorStop(1, `rgba(${primaryColor.r}, ${primaryColor.g}, ${primaryColor.b}, 0)`);
